...
#4. Definicion de variables y calculo___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________
...
#5. Interfaz Pestaña 1___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________
        ...
        with tab1:
                ...
                recursos_grid_response = AgGrid(st.session_state.recursos_df, gridOptions=grid_options, update_mode=GridUpdateMode.MODEL_CHANGED,custom_css=custom_css, key='recursos_grid_tab1') 
                ...
                dependencias_grid_response = AgGrid(st.session_state.dependencias_df, gridOptions=grid_options, update_mode=GridUpdateMode.MODEL_CHANGED,custom_css=custom_css, key='dependencias_grid_tab1')
                st.session_state.dependencias_df = pd.DataFrame(dependencias_grid_response['data'])

# 5. Interfaz Pestaña 2___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________

        with tab2:
                st.subheader("Configuración de Calendario Laboral")
                ...
                st.markdown("---")
                st.write("Indicar días no laborables o jornada laboral")
...
# 6. Calculo de algoritmos y funciones___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________
        try:
...
# 7. Pestaña 3 Interfaz___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________            
        ...
        with tab3:
                ...
                column_config["RENDIMIENTO"] = st.column_config.NumberColumn(
                        ...
                        format="%.4f",
                        step=0.0001,
                        disabled=("RENDIMIENTO" not in columnas_editables)
                )
...
# 8. Interfaz de la Pestaña 4___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________            
...
# 9. Interfaz de la Pestaña 5___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________            
        ...
        with tab6:
                ...
                if "tareas_df_seguimiento" in st.session_state:
                    ...
                    for _, seg_row in df_seg.iterrows():
                        ...
                        fig.add_trace(go.Scatter(
                            x=[end_date_real + timedelta(days=0.3)],
                            y=[y_center + 0.25],
